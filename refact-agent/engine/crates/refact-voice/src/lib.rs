...
use tokio::sync::{broadcast, mpsc, oneshot, watch, Mutex as AMutex, RwLock as ARwLock};
#[cfg(feature = "voice")]
use tracing::info;

#[cfg(feature = "voice")]
pub use audio_decode::decode_audio;
#[cfg(feature = "voice")]
pub use models::WhisperModel;
#[cfg(feature = "voice")]
pub use types::DownloadModelResponse;
pub use types::{
    DownloadModelRequest, StreamingChunkRequest, StreamingTranscriptEvent, TranscribeRequest,
    TranscribeResponse, TranscribeResult, VoiceStatusResponse, VoiceStreamEvent,
};
...
mod tests {
    ...
    #[test]
    fn voice_service_reports_feature_state() {
        assert_eq!(VoiceService::is_enabled(), cfg!(feature = "voice"));
    }
}
